...
template <typename T, typename Hessian>
__host__ __device__ void ddEddX(Hessian& R, const T& lambda, const T& mu, const Eigen::Vector<T,9>& X, const Eigen::Matrix<T,2,2>& IB)
{
/*****************************************************************************************************************************
Function generated by SymEigen.py 
Author: MuGdxy
